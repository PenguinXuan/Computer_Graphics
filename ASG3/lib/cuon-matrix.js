...
class Vector3 {
    ...
    dot(other1, other2) {
        ...
        let x1 = other1.elements[0], y1 = other1.elements[1], z1 = other1.elements[2],
            x2 = other2.elements[0], y2 = other2.elements[1], z2 = other2.elements[2];
    ...
    cross(other) {
        ...
        let x1 = this.elements[0], y1 = this.elements[1], z1 = this.elements[2],
            x2 = other.elements[0], y2 = other.elements[1], z2 = other.elements[2];
        let x3 = (y1 * z2) - (z1 * y2), y3 = -((x1 * z2) - (z1 *  x2)), z3 = (x1 * y2) - (y1 * x2);
    ...
    normalize() {
        ...
        this.elements[0] = x / mag;
        this.elements[1] = y / mag;
        this.elements[2] = z / mag;
        // Don't delete the return statement.
        return this;
    }
